...
const Register = () => {
    const {googleLogin, createAccount, LogOut} = useAuth()
    ...
    const handleRegister = (e)=>{
      ...
      .then(res=>{
        updateProfile(auth.currentUser, {
          displayName: userInfo.name, photoURL: userInfo.photoURL
        })
    ...
    <div className="relative overflow-hidden">
      <div className="mx-auto max-w-screen-md py-12 px-4 sm:px-6 md:max-w-screen-xl md:py-20 lg:py-32 md:px-8">
        <div className="md:pr-8 md:w-1/2 xl:pr-0 xl:w-5/12">
          ...
          {/* <!-- End Form --> */}
          <p className="my-4 text-right">Already have an account? <Link className="font-semibold text-blue-500" to={'/login'}>Login</Link></p>
        </div>
      </div>
